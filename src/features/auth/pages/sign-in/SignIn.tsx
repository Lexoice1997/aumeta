      ...
      <div className={styles.body}>
        ...
        >
          <Item
            ...
            name="email"
          >
            <Input size="large" placeholder={t("authEmailPlaceholder")} />
          </Item>
          <Item
          ...
          <Link to={rootPaths.AUTH.RESET_PASSWORD}>
            {t("signInSection.forgotPassword")}
          </Link>
          <Button
            size="large"
            ...
            htmlType="submit"
          >
            {t("signInSection.button-text")}
          </Button>
          <div className={styles.body__sign_up}>
            {t("signInSection.noAccountPrompt")}{" "}
            <Link to={rootPaths.AUTH.SIGN_UP}>
              {t("signInSection.createAccount")}
            </Link>
          </div>
        </Form>
      </div>
